...
namespace io.harness.cfsdk.HarnessOpenMetricsAPIService
{
    ...
    public partial class Client 
    {
        ...
        public Client(System.Net.Http.HttpClient httpClient, ILogger logger = null)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        _logger?.LogInformation("API call: url: {Url}, status: {Status}", url_, status_);
    ...
    {
        /// <summary>time at when this data was recorded</summary>
        ...
        /// <summary>This can be of type FeatureMetrics</summary>
